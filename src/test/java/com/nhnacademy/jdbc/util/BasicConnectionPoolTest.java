...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://133.186.241.167:3306/nhn_academy_11","nhn_academy_11","T.T(RA8D7p2GLjz/",5);
    }
